...
# a (3) = -1, 0, 1
# b (5) = 0.25, 1, 4, 16, 64
# x_dist (4) = uniform, normal, lognormal, even_discrete
# n (3) = 50, 100, 300
# rep (3)
#
# 3 * 5 * 4 * 3 * 3 = 540
#
# null lineups for heter and poly (the null models are exactly the same):
# x_dist (4)
# n (3)
# rep (3)
# 4 * 3 * 3 = 36
...
# 576 * 5 / 18 = 160
#
# We need 160 subjects to evaluate 540 lineups and 36 null lineups for 5 times


set.seed(10086)

# Generate unique lineups
lineup <- expand.grid(a = c(-1, 0, 1),
                      b = c(0, 0.25, 1, 4, 16, 64),
                      n = c(50, 100, 300),
