...
1. The first project provides a prototype of automatic visual inference system for evaluating lineups of residual plots, with a focus on the classical normal linear regression model given it is one of the simplest predictive models. The core of the system 
...
2. The second project aims to develop an automatic visual inference system based on image comparison. 
