...
On top of the pre-trained model, we added a 2D global average pooling layer [@lin_network_2014], followed by a fully-connected dense layer with 256 nodes, a dropout layer [@srivastava_dropout_2014] with 20% dropout rate, and a output layer with softmax as activation function. A diagram of the model architecture is given in Figure \ref{fig:model-arch}. 
