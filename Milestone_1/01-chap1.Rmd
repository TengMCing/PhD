...
The performance of all five models evaluated on the test set is given in Table \ref{tab:null-true-eval}. From the result, we observed that the average balanced accuracy for all five models were around 80%. Breaking down into null and actual data plot, it was found that
...
null_true_eval_dat %>%
  ...
  knitr::kable(col.names = c("", "Actual data plot detection rate", "Null plot detection rate", "Average detection rate"), 
             booktabs = TRUE, 
             caption  = 'Performance of computer vision models on null residual plot and acutal data plot of test data.', 
