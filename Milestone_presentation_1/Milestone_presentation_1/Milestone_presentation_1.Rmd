...
#### **2** out of **20** lineups are extremely easy lineup which are used as attention checks. Participants need to pass at least one.
...
#### There is a huge gap between the conventional curves and the visual test curves at the middle of the plot.
...
#### We proposed an **automatic visual inference system** for evaluating lineups of residual plots of classical normal linear regression.
