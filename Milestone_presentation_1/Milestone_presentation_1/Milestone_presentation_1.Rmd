...
#### The estimated power is further used in fitting a **quasi-binomial generalized linear model** with natural logarithm of effect size as the only regressor.
