...
- While such rejections may be **statistically correct**, their **sensitivity** may render the results **impractical**. **Minor defects** in the model are **unlikely** to have a **significant impact** and may be best disregarded for practical purposes. 
...
If we embed the residual plot in a matrix of **null plots**, we will find the visual discovery is 
