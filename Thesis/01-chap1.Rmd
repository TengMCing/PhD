...
Lemma \@ref(lemma:heter) shows 

This shows that the variance of the residuals is clearly a function of X and Z. Hence, we
would expect to see some patterns in the residual plot.
