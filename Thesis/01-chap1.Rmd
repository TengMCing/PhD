...
## Limitations of Lineup Protocol and Automatic Visual Inference
...
Therefore, we first tried to automate the visual diagnostics of one of the simplest statistical models - classical normal linear regression model. Two common types of model defects were created and visualized using residuals vs. fitted values plot. To set up a comparison between the computer vision models and humans, human subject experiments were conducted to understand the ability of human reading residual plots.
...
For an automatic visual inference system, there are several possibilities of the type of inputs.
...
null_true_eval_dat %>%
  ...
  knitr::kable(col.names = c("Model", "Actual data plot correct rate", "Null plot correct rate", "Average correct rate"), 
             booktabs = TRUE, 
