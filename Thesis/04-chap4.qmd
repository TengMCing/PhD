...
```{r fig-summary-plot, echo = TRUE, fig.height=3, fig.width=6, fig.cap="Summary plot comparing the densities of VSS for bootstrapped residual samples relative to VSS for null plots (blue)."}
