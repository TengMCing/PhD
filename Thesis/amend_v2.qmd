...
## Responses to Comments from Examiner Prof. Louise Ryan:
...
I have revised the abstract to ensure that it provides a clear and concise overview of the thesis in a manner accessible to a broader audience, including non-experts. Technical terms such as "lineup protocol" have been either omitted or explained briefly with contextual statements to ensure clarity for readers unfamiliar with these concepts. For instance, I have included a sentence explaining that the lineup protocol is a statistical visualization approach that embeds a data plot among null plots to compare patterns arising by chance with those observed in the data.
...
Thank you for this suggestion. I have added a statement in Chapter 1 to highlight the wide-ranging applications of regression diagnostics across various models. I also clarified that the primary focus of my thesis is on diagnostics for classical normal linear regression model to establish this context early on.
...
I agree that including a visual representation of the lineup protocol in the introduction would help clarify its concept and engage the reader. I have added a diagram in Chapter 1 to illustrate how the lineup protocol works, providing an example similar to those discussed in Chapter 2. This addition should help familiarize readers with the protocol from the outset.
...
The recruitment details are provided in the appendix. The subjects received training by reading a webpage with examples. Unfortunately, I am unable to modify this chapter further, as it has already been submitted as a paper and accepted, requiring it to remain unchanged.
...
I completely agree that Tukey’s contributions were foundational and greatly impactful. While I appreciate the suggestion to add more references to his work earlier in the thesis, I did not find a suitable place where they would naturally fit within the context. However, I’m glad the reference in Chapter 3 resonated with you.

7. *There are a few places where technical terms are used but not defined. e.g page 30, what is "dynamic input size"?*

I appreciate your careful observation. I’ve addressed the issue by improving the language for better clarity in Chapter 3, such as changing "dynamic input size" to "variable input size" and providing a clear definition on page 30. I appreciate your attention to detail and constructive feedback!
...
Thank you for pointing this out. To avoid confusion, I have clarified the terminology by changing "model specification" in Section 3.2 to "Computer Vision Model Specifications." This should make it clearer that the term refers specifically to the details of the computer vision model and not the underlying statistical model being critiqued. I appreciate your feedback!

10. *page 40, I don’t see here where you talk about how you generate the values of x1 and x2?*

I appreciate you bringing this to my attention. I have added a paragraph in Section 3.7 to provide more details on how the predictors $x_1$ and $x_2$ in the training datasets are generated. I appreciate your careful review and feedback!
...
I’m grateful for your observation. The placement of Figure 3.1 was indeed a formatting issue in the original document. This has since been fixed, and the figure now appears much closer to its citation in the text. I appreciate your attention to this detail!

## Responses to Comments from Examiner Prof. Daniela Witten:
...
In contrast, computer vision models can evaluate lineups with as many null plots as desired, which is one of their advantages.
...
Thank you for this valuable suggestion. I will include a discussion on this point in the manuscript currently being prepared for the peer-reviewed journal.
