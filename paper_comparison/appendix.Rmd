...
```{r conv-x-dist, fig.cap = "Change of power of conventional tests under different fitted value distribution for non-linearity model and heteroskedasticity model.", fig.height = 4}
