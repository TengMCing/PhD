...
upper_lower_p %>%
  ...
  mutate(case = ifelse(!adjusted_reject, "p-value < 0.05 but adjusted p-value > 0.05", "p-value > 0.05 but adjusted p-value < 0.05")) %>%
  ...
  kableExtra::kable(format = "latex", booktabs = TRUE, label = "sensitivity", 
                    escape = FALSE,
                    caption = "Change of rejection decision because of the modification of $\\alpha$.")
```
