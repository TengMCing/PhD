  ...
  for (i in 1:100)
  {
    poly_conv_sim[[i]] <- map(1:2000,
                     ...
                     tibble(shape = shape,
                            ...
                            RESET_p_value = mod$test(tmp_dat, test = "RESET", power = 2:3, power_type = "fitted")$p_value,
  ...
  for (i in 1:100)
  {
    heter_conv_sim[[i]] <- map(1:2000,
                     ...
                     tibble(a = a,
                            ...
                            RESET_p_value = POLY_MODEL$test(tmp_dat, test = "RESET", power = 2:3, power_type = "fitted")$p_value,
