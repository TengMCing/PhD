...
VI_MODEL$plot_lineup(vi_lineup[["poly_39"]]$data, 
                     remove_grid_line = TRUE, 
                     theme = theme_light(base_size = 5),
                     remove_axis = TRUE)

VI_MODEL$plot_lineup(vi_lineup[["poly_415"]]$data, 
                     remove_grid_line = TRUE, 
                     theme = theme_light(base_size = 5),
                     remove_axis = TRUE) -> p1

VI_MODEL$plot_lineup(vi_lineup[["poly_131"]]$data, 
                     remove_grid_line = TRUE, 
                     theme = theme_light(base_size = 5),
                     remove_axis = TRUE) -> p2

VI_MODEL$plot_lineup(vi_lineup[["poly_322"]]$data, 
                     remove_grid_line = TRUE, 
                     theme = theme_light(base_size = 5),
                     remove_axis = TRUE) -> p3

VI_MODEL$plot_lineup(vi_lineup[["poly_378"]]$data, 
                     remove_grid_line = TRUE, 
                     theme = theme_light(base_size = 5),
                     remove_axis = TRUE) -> p4
