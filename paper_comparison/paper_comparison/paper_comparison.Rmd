---
title: |
  Why is it that statistical tests are not widely used in regression diagnostics? An explanation using visual inference.
...
p <- vi_survey %>%
  ...
  geom_segment(data = data.frame(xi = es), aes(x = xi, xend = xi, y = 0, yend = 1), alpha = 0.3, col = "grey") +
