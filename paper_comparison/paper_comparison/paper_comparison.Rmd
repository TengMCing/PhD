...
We also investigate the impact of the shape of heteroskedasticity on the power of different tests. The corresponding result is presented in Figure \ref{fig:heter-power-a}. In theory, the "Left-triangle" and the "Right-triangle" should have no difference from the point of view of a Breusch-Pagan test. According to Figure \ref{fig:heter-power-a}, this is indeed the case. And these two shapes should have the same visual test power, unless the orientation of the visual pattern is a non-negligible factor from human perspective. However, the same graph suggests that the "Right-triangle" shape is more difficult to be noticed by subjects than the "Left-triangle" shape.
