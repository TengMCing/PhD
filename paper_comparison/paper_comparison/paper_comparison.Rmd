...
Shape of the non-linearity pattern is another factor contributes to the non-linearity model. With different non-linearity patterns, it is expected that the visual test will respond variously.
...
```{r poly-power-uniform-j, fig.height = 4, fig.cap = "Power of conventional tests and visual tests on lineups containing four different non-linearity shapes. Power curves with higher order of non-linearity are drawn with deeper colours."}
