...
In particular, given 95% confidence level, both tests will agree on the rejection in only around 58% of the cases. And in 41% of the cases, the visual test does not reject the null hypothesis but the conventional test does. In these 41% of the cases, though we know that the designed lineups contain various degrees of residual departures, analysts and the general public as the consumers of the output may not believe in the rejection of the null hypothesis, or at least may not consider the model violation as impactful, simply due to the fact that the departures are not clearly visible to them.

This makes it sounds like people are arrogantly ignoring the accuracy of conventional tests and trust too much to their visual perception, but it is not. In fact, the sensitivity of the conventional test could sometimes distract and discourage analysts from finding a good linear approximation to the data. The rejection of the null hypothesis because of acceptable and negligible residual departure is not practically useful and thus is usually viewed as "false alarm" by analysts. Relying on visual perception to determine the quality of the regression model is just a way to  

Alternatively, 



From a practical sense, data plots and the visual test provide better measure of the seriousness of the residual departure.


One noticeable difference compared to the result provided in @buja_statistical_2009 is the lack of data points 

Note that 


This also partly explains why abundance of literature suggesting the use of data plot in regression diagnostics.
