...
vi_survey %>%
  ...
  filter(conv_reject == "Not") %>%
  View()
  count(conv_reject, reject)
```
...
<!--For lineups produced by the heteroskedasticity model, 55% are rejected by both the conventional test and the visual test, and 24% are accepted by both, result in 79% agreement rate. Percentage of lineups only rejected by conventional test are 20%.-->
