...
vi_survey %>%
  ...
  ggplot() +
  ggmosaic::geom_mosaic(aes(x = ggmosaic::product(conv_reject, reject), fill = conv_reject)) +
  xlab("Visual tests") +
  ylab("Conventional tests") +
