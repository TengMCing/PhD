...
p <- vi_survey %>%
  ...
  # Draw bootstrap visual test power curves
...
```{r different-x-dist-poly-power, fig.cap = "Comparison of power of conventional tests and visual tests on lineups with different fitted value distributions. Each power curve of the uniform distribution is surrounded by a grey line to indicate it is the baseline in its group. Conventional tests are more sensitive than visual tests in regards of the type of the simulated model and the fitted value distribution. For non-linearity patterns, visual tests show lower power with discrete uniform distribution, possibly due to the difficulty in reading discreteness. For heteroskedasticity patterns, because of the unevenness, visual tests have lower power with normal and lognormal distribution."}
...
```{r poly-power-j, fig.height = 4, fig.cap = "Comparison of power of conventional tests and visual tests on lineups containing four different non-linearity shapes. "}
