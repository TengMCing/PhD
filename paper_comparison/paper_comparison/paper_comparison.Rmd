...
Except for the parameters summarised in Table \ref{tab:model-parameter-table}, three additional parameters $n$, $\sigma$ and $b$ were used to control the strength of the signal so that different difficulty levels of lineups were generated, and therefore, the estimated power curve would be smooth and continuous. 

In experiment I, II and III, three different sample sizes were selected (n = 50, 100, 300). In general, with fewer data points drawn in a residual plot, the chance of detecting the visual pattern will decrease. This can be observed from Figure \ref{fig:different-n}.
...
Four different levels of $sigma$ 
