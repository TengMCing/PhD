...
```{r different-x-dist-heter-power, fig.height = 3, fig.width = 7, fig.cap = "Power of conventional tests and visual tests on lineups produced by the heteroskedasticity model under different distributions of regressor."}
