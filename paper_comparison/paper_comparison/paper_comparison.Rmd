...
vi_survey %>%
  ...
  ggplot() +
  geom_smooth(aes(log_effect_size, reject_dirichlet, col = "Visual p-value"), method = "glm", method.args = list(family = binomial), se = FALSE) +
  ...
  geom_smooth(data = mutate(poly_conv_sim, log_effect_size = log(effect_size)) %>%
                ...
                mutate(name = gsub("_p_value", " p-value", name)), 
