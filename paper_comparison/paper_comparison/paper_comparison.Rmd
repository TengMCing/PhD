...
This research is enabled by the use of the following `R` packages:
cli, curl, dplyr, ggplot2, jsonlite, lmtest, mpoly, progress, tibble, ggmosaic, purrr, tidyr, readr, stringr, here, kableExtra, patchwork, rcartocolor. The study website is powered by pythonAnywhere and the Flask web framework. The jsPsych framework is used to create behavioral experiments that run in our study website. 
