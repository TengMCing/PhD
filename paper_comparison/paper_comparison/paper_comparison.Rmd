...
The article was created with rticles (ref here), knitr (ref here) and R Markdown (ref here). The project's Github repository (link here) contains all materials required to reproduce this article.
