...
Example residual plots given in \ref{fig:commondepartures} are examined
by the corresponding F-test, Breusch-Pagan test and Shapiro--Wilk test
as shown in \ref{tab:example-residual-plot-table}. In the example, both
the Breusch-Pagan test and the Shapiro--Wilk test rejects the null
