...
\textbackslash caption\{ A large amount of subjects select the residuals
plot with the lowest p-value. But greater than 50\% of subjects evenly
select other plots.\}\label{fig:plotsel} \textbackslash end\{figure\}
