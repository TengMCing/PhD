...
\caption{Polynomial forms generated for the residual plots used in data collection period I. The four shapes are generated by varying the order of polynomial given by $j$ in $He_j(.)$.}\label{fig:different-shape-of-herimite}
\end{figure}
