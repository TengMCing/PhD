...
\caption{Comparison of power of conventional tests and visual tests on lineups produced by the non-linearity model under different fitted value distributions.}\label{fig:different-x-dist-poly-power}
\end{figure}
