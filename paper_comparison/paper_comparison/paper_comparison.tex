...
\hypertarget{calculation-of-p-value-and-power}{%
\section{\texorpdfstring{Calculation of \(p\)-value and
power}{Calculation of p-value and power}}\label{calculation-of-p-value-and-power}}

\hypertarget{hypotheses}{%
\subsection{hypotheses}\label{hypotheses}}

Before the discussion of the p-value and power, the difference in
hypotheses between conventional tests and visual tests worth a
clarification.
...
The conventional tests are only equipped to measure specific residual
departures, and thus have a more specific null and alternative
hypotheses being tested. For instance, the RESET test with the auxiliary
regression formulated as
\[\boldsymbol{e} = \gamma_1\hat{\boldsymbol{y}}^2 + \gamma_2\hat{\boldsymbol{y}}^3 + \gamma_3\hat{\boldsymbol{y}}^4 + \boldsymbol{u}, \boldsymbol{u} \sim N(\boldsymbol{0}, \sigma_u^2\boldsymbol{I})\]
has \(H_0:\gamma_1 = \gamma_2 = \gamma_3 = 0\) and
\(H_1: \gamma_1 \neq 0 \text{ or } \gamma_2 \neq 0 \text{ or } \gamma_3 \neq 0\).
In contrast, the visual test has the null hypothesis same as the general
\(H_0\) and \(H_1\) provided above. Essentially, a visual test can be
seen as a collection of tests targeting for different residual
departures.
