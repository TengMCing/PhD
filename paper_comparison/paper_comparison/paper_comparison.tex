...
of the horizontal axis as shown at the bottom-right of Figure
\ref{fig:commondepartures}.
...
\begin{figure}
\includegraphics[width=1\linewidth]{paper_comparison_files/figure-latex/fig:power-poly-uniform-1} \caption{...}\label{fig:fig:power-poly-uniform}
\end{figure}
