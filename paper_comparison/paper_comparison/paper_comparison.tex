...
the power of testing the ``triple-U'' shape drops significantly. To
...
``triple-U'' shape will be only slight lower than the power curve of
``M'' shape. The recommendation of the polynomial power for the RESET
should be revised, perhaps. This illustrates the sensitivity of
...
chance of detecting the ``butterfly'' shape are higher than other two
shapes in both conventional and visual testing.
