...
{\centering \includegraphics[width=1\linewidth]{paper_comparison_files/figure-latex/compare-reject-1} 

}

\caption{Comparison of conventional and visual test rejection rates.}\label{fig:compare-reject}
\end{figure}
