...
The same model is fit on different subsets of the collated data to study
the effect of different factors have on the power of the visual test.
...
visual test against natural logarithm of the effect. Without further
concenring different component contributing to the effect,
