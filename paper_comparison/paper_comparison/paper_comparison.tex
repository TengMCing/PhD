...
rejected by the conventional test, 49\%, so approximately half as many
as the conventional test. Surprisingly, the visual test rejects 14\% of
lineups where the conventional test does not reject.

are rejected by both the conventional and visual tests, while 42\% are
accepted by both tests. Thus, 69\% of the time two tests will agree with
each other. There are 26\% of lineups rejected by conventional tests
only.
