...
Table \ref{tab:parameter-table} resulting in 443 different lineups. For
...
residual plots with one randomly placed actual data plot.

Overall, we planned to collect 7974 evaluations on 1152 uniqued lineups
performed by 443 subjects throughout three experiment.

In addition, each lineup is designed to be evaluated by five different
subjects to provide reasonable estimates of the visual p-value.

Thus, \(192 \times 3 \times 5 / (20 - 2) = 160\) subjects were recruited
to satisfy the design of the experiment I.
