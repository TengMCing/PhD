...
departures from a good residual plot. We will only discuss three most
commonly checked departures in this paper. Namely, non-linearity,
heterskedasticity and non-normality.
...
the visual p-value followed by the beta-binomial model is given as
