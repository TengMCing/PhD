...
\hypertarget{caluculation-of-p-value-effect-size-and-power}{%
\section{Caluculation of p-value, effect size and
power}\label{caluculation-of-p-value-effect-size-and-power}}

Visual inference is

To be able to properly compare conventional tests to visual tests, we
need to define the effect size of the residual departure, the power of
the tests under a certain level of effect size,

\hypertarget{caluculation-of-effect-size}{%
\subsubsection{Caluculation of effect
size}\label{caluculation-of-effect-size}}

\hypertarget{caluculation-of-p-value}{%
\subsubsection{Caluculation of p-value}\label{caluculation-of-p-value}}
...
\hypertarget{caluculation-of-power}{%
\subsubsection{Caluculation of power}\label{caluculation-of-power}}
...
aggressively from 10\% to 100\% as \(log_e(E)\) increases from 0 to 2.5,
