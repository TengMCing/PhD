...
\hypertarget{effect-of-other-factors}{%
\subsection{Effect of other factors}\label{effect-of-other-factors}}
...
distribution of the fitted values and the visual effect of the residual
plot. In our experiments, four distributions of the regressor are used
