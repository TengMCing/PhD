...
## Graphical Inference for Infovis - Hadley Wickham, Dianne Cook, Heike Hofmann and Andreas Buja (2010)
...
### Section 2 - What is inference and why do we need it?
...
### Section 3 - Protocols of graphical inference
...
One can implement these two protocols using the R package `nullabor`.
...
## Graphical Perception: Theory, Experimentation, and Application to the Development of Graphical Methods - William S. Cleveland and Rovert McGill (1984)
